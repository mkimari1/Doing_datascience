...
The below shows a bar graph for IBU for the Second half of the data
...
classifications = knn(train[,c(3,4)],test[,c(3,4)],train$Label, prob = TRUE, k = 3)
...
classifications = knn(train[,c(3,4)],test[,c(3,4)],train$Label, prob = TRUE, k = 5)
table(classifications,test$Label)
confusionMatrix(table(classifications,test$Label))
```
